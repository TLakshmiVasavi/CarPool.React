...
class MyRides extends React.Component
{
    ...
    componentDidMount()
    {
        axios.get('https://localhost:5001/api/RideApi/GetOfferedRides?userId=tlakshmivasavi005@gmail.com')
        .then(res=>{
            console.log(res);
            this.setState({Offers:res.data});
        });
        axios.get('https://localhost:5001/api/RideApi/GetBookings?userId=tlakshmivasavi005@gmail.com')
        .then(res=>{
            console.log(res);
